...
# PENDING: two layer build to decrease image size, create kind local registry, push to local registry, spin up istio with helm, spin up prometheus+grafana with helm